...
const Experience = () => {
  ...
  return (
    <Layout header="white">
     <SEO title={`${data.site.siteMetadata.author} experience`} description={`experience of ${data.site.siteMetadata.author}`}/>
          ...
          <div className={`${experienceModule.row} ${experienceModule.cf}`}>
            <div className={`${experienceModule.block} ${experienceModule.fl}`}>
              <p className={experienceModule.p}>
                <span className={`${experienceModule.circle} ${experienceModule.first}`} />
                <h3>company name</h3>
                Quisque enim quam, semp quis dui sed,
                pellentesque consectetur augue. Nam convallis diam lacus, vel
                posuere lacus adipiscing et.
                mauris dapibus, ut aliquet odio posuere. Quisque enim quam,
                mauris dapibus, ut aliquet odio posuere. Quisque enim quam,
              </p>
            </div>
